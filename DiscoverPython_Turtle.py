...
# I WANT TO GET THROUGH EXERICSES A - L: each exercise is a BUILDING BLOCK to that final fireworks computer-generated graphic, so please try to understand what's going on
	#Because you're new to Python you won't be able to judge what you're achieving, but THE END PROGRAM IS PROPERLY TECHNICAL - my UCL TA friend has asked for the source code
# There are 2 ways to run code ^for any language: 
	# 1. line by line in a console
	# 2. write a whole program which is stored in a file which then gets executed by an interpreter
...
#Therefore, if you want to write a somewhat longer program, you are better off using a text editor 
...
##### SHOW CONSOLE: Run some Python code line by line
...
##### Exercise A: Run Python code as a script | As you can see, the Console is good for simple instructions - however, most of the time you'll be writing a Python script
